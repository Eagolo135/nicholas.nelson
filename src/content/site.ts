...
export const site: SiteContent = {
  ...
  projects: [
    ...
    },
    {
      ...
      statusTone: 'pending',
      summary: 'A revised class project being improved for portfolio presentation through clearer writing, stronger organization, cleaner visual design, and a more professional explanation of purpose.',
      description:
        'This revised midterm project is being reframed as a portfolio-ready case study rather than left in class-submission form. The source content still marks the exact project title, tools, and links as TODO, so the public summary remains explicit about what is still missing.',
      tags: ['revision', 'portfolio presentation', 'documentation', 'pending details'],
      searchTerms: ['midterm', 'revision', 'class project', 'portfolio polish', 'pending'],
      proof: [
        'Revision emphasis is on clearer writing, stronger organization, and cleaner visual design.',
        'The project is being rewritten to explain its purpose more professionally as a portfolio piece.',
        'Exact title, topic, tools, links, and screenshots remain intentionally marked as TODO in the source document.',
      ],
      capabilities: [
        {
          title: 'Portfolio reframing',
          body: 'The work is being revised to read like a finished case study instead of a classroom hand-in.',
        },
        {
          title: 'Clearer explanation',
          body: 'The revision focuses on making the project easier to understand and more professional in its purpose and presentation.',
        },
        {
          title: 'Evidence discipline',
          body: 'Unverified specifics stay out of the public summary until the underlying details can be added correctly.',
        },
        {
          title: 'Presentation quality',
          body: 'The project highlights revision quality, communication, and visual polish as part of the final portfolio presentation.',
        },
      ],
      architecture: [
        {
          title: 'Clarify the project brief',
          body: 'The exact title, topic, tools, and original project scope need to be confirmed before the final public version is published.',
        },
        {
          title: 'Document the revision improvements',
          body: 'The public write-up should explain what changed in the rewrite, organization, design, and presentation quality.',
        },
        {
          title: 'Publish the verified portfolio version',
          body: 'Only after the missing fields are resolved should the project gain final links, screenshots, and a full project summary.',
        },
      ],
      commandPreview: [
        '[STATUS] Revised midterm case study in progress.',
        '[TODO] Add project title, topic, tools, links, and screenshots if available.',
        '[NEXT] Replace placeholder summary with the verified final project narrative.',
      ],
    },
    {
    ...
    },
    {
      ...
      statusTone: 'active',
      summary: 'TypeScript project from the GitHub portfolio with a live deployment available.',
      description:
        'Repository-backed project added directly from the GitHub account so the portfolio reflects active public work and keeps source access one click away.',
      tags: ['typescript', 'github', 'web project'],
      searchTerms: ['anime-site', 'github', 'typescript', 'project repository'],
      proof: [
        'Sourced directly from the public GitHub repository list.',
        'Included to keep the project section aligned with current GitHub projects.',
        'Provides direct source access for reviewer validation.',
      ],
      capabilities: [
        {
          title: 'Repository visibility',
          body: 'This entry ensures the portfolio mirrors public code work from GitHub.',
        },
        {
          title: 'Source-first review',
          body: 'Reviewers can open the repository immediately and inspect code directly.',
        },
      ],
      architecture: [
        {
          title: 'GitHub source mapped',
          body: 'Repository metadata is represented as a project card in the portfolio.',
        },
        {
          title: 'Links surfaced in modal',
          body: 'The project modal exposes source and live links for fast validation.',
        },
      ],
      commandPreview: [
        '[SYNC] GitHub repository added to portfolio project inventory.',
        '[LINK] Source and live URLs attached for reviewer access.',
      ],
      links: {
        sourceLabel: 'View Source Repository',
        sourceHref: 'https://github.com/Eagolo135/anime-site',
        docsLabel: 'Open Live Demo',
        docsHref: 'https://anime-site-pearl.vercel.app',
      },
    },
    {
      slug: 'cli-ai-toolkit',
    ...
    },
    {
      ...
      status: 'Repository Linked',
      statusTone: 'active',
      summary: 'TypeScript repository included from the full GitHub project inventory.',
      description:
        'This entry ensures the TechBlogger repository is visible in the portfolio projects surface with direct source access.',
      tags: ['typescript', 'blogging', 'web project'],
      searchTerms: ['TechBlogger', 'typescript project', 'github repository'],
      proof: [
        'Project card generated from account-level GitHub repository data.',
        'Source link attached for reviewer verification.',
      ],
      capabilities: [
        {
          title: 'Account-wide project coverage',
          body: 'Completes inclusion of public repositories in the portfolio project list.',
        },
        {
          title: 'Source transparency',
          body: 'Lets reviewers open and inspect code with a single click from the modal.',
        },
      ],
      architecture: [
        {
          title: 'Repo metadata normalization',
          body: 'GitHub repository data is translated into the shared card and modal schema.',
        },
        {
          title: 'Filter/search indexing',
          body: 'Tags and search terms are added so the entry is discoverable in the projects UI.',
        },
      ],
      commandPreview: [
        '[SYNC] TechBlogger added to project inventory from GitHub.',
        '[INDEX] Search metadata and source links configured.',
      ],
      links: {
        sourceLabel: 'View Source Repository',
